# Improve Ingredients Checklist

`RecipeDetailsPage` contains `Ingredients Checklist` in `Cooking mode`. All
ingredients are listed in one long list. Improve this checklist by grouping
ingredients by recipe stage.
