...
description: Generates Angular code and provides architectural guidance. Trigger when generating new code or updating existing code for components, services, directives and pipes or for best practices on reactivity (signals, linkedSignal, RxJS), forms, dependency injection, routing, animations, styling (component styles, SCSS), testing, or CLI tooling.
---

# Angular Developer Guidelines

1. Always analyze the project's Angular version before providing guidance, as
...
In all cases, **prefer reactive forms**.
