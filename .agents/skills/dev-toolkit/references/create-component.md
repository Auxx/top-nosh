...
2. Angular component generator is invoked using `nx g @lmgm/dev-toolkit:component` followed by required arguments
...
```bash
nx g @lmgm/dev-toolkit:component --project=<project-name> --feature=<feature-name> --name=<component-name> --no-interactive --dry-run
```
...
```bash
nx g @lmgm/dev-toolkit:component --project=<project-name> --feature=<feature-name> --name=<component-name> --no-interactive
```
