...
Create a new Angular directive and scaffold directive code.
...
- New directive name: must be a non-empty string (convert to camel case and pass to generator as `--name` argument)
...
Directive generator provides a starting point. Modify the output as needed to:
